...
const skills = () => {
  return (
    <>
      <Head>
        <title>Skills</title>
        <meta name="description" content="These are development Skills!" />
      </Head>
        ...
        <Layout className="pt-16">
          ...
          <div className="mt-16 w-full h-auto grid grid-cols-2 gap-10">
            <Card
              ...
              iconComponent={<ReactIcon className="text-5xl" />}
            />
            <Card
              title="JavaScript"
              desc={
              ...
              iconComponent={<JavaScriptIcon className="text-5xl" />}
            />
            <Card
              title="NodeJs"
              desc={
              ...
              iconComponent={<NodeJsIcon className="text-5xl" />}
            />
            <Card
              title="TypeScript"
              desc={
              ...
              iconComponent={<TypeScriptIcon className="text-5xl" />}
            />
            <Card
              title="NextJs"
              desc={
              ...
              iconComponent={<NextJsIcon className="" />}
            />
            <Card
              title="ExpressJs"
              desc={
              ...
              iconComponent={<ExpressJsIcon className="text-5xl" />}
            />
            <Card
              title="MongoDb"
              desc={
              ...
              iconComponent={<MongoDbIcon className="text-5xl" />}
            />
            <Card
              title="CSS"
              desc={
              ...
              iconComponent={<CSSIcon className="text-5xl" />}
            />
            <Card
              title="Html"
              desc={
              ...
              iconComponent={<HtmlIcon className="text-5xl" />}
            />
            <Card
              title="Tailwind CSS"
              desc={
              ...
              iconComponent={<TailwindCSSIcon className="text-5xl" />}
            />
          </div>
        </Layout>
      </main>
